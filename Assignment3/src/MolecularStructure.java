...
public class MolecularStructure {
    ...
    public boolean equals(Object obj) {
        ...
        List<Molecule> thisMolecules = this.molecules;
        MolecularStructure other = (MolecularStructure) obj;
        List<Molecule> otherMolecules = other.molecules;
        Collections.sort(thisMolecules);
        Collections.sort(otherMolecules);

        return thisMolecules.equals(otherMolecules);
    }
